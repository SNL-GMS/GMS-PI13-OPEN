...
public class Cd11Validator {
  ...
  // TODO: Determine if there are more station types...
  ...
  public static String validStationOrResponderType(String name) {
    checkArgument(KNOWN_STATION_TYPES.contains(name.substring(0, 3).trim()),
        "Unknown station or responder type %s (only know %s)",
