...
public class Cd11AcknackFrame extends Cd11Frame {
   ...
   */
  public Cd11AcknackFrame(Cd11ByteFrame cd11ByteFrame) {
    super(cd11ByteFrame);
   ...
   */
  public Cd11AcknackFrame(String framesetAcked, long lowestSeqNum, long highestSeqNum,
      long[] gapRanges) {
  ...
  /**
   * Creates an acknack frame with all arguments for frame Parsing Utility.
   *
   * @param framesetAcked full name of the frame set being acknowledged (for example, "SG7:0")
   * @param lowestSeqNum lowest valid sequence number sent considered during the current connection
   * for the set (0 until a frame set is no longer empty)
   ...
   */
  public Cd11AcknackFrame(String framesetAcked, long lowestSeqNum, long highestSeqNum,
      long [] gapRanges, PartialFrame partialFrame) {
  ...
  private void validate() {
    ...
    checkNotNull(this.gapRanges);
    checkState(this.gapRanges.length % 2 == 0,
        "Must have an even number of gap ranges");
    checkState(this.gapCount * 2 == gapRanges.length,
  ...
  public boolean equals(Object o) {
    ...
    if (!Objects.equals(framesetAcked, that.framesetAcked)) {
      return false;
    }
  ...
  public String toString() {
    return "Cd11AcknackFrame { " + "frameType: \"" + frameType + "\", "
        + "framesetAcked: \"" + framesetAcked + "\", "
        + "lowestSeqNum: " + lowestSeqNum + ", "
        + "highestSeqNum: " + highestSeqNum + ", "
        + "gapCount: " + gapCount + ", "
        + "gaps: \"" + Arrays.toString(gapRanges) + "\" "
        + "}";
  }
}
