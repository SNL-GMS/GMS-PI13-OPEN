...
public class Cd11FrameHeader {
   ...
   */
  public Cd11FrameHeader(ByteBuffer input) {
    input.rewind();
  ...
  public Cd11FrameHeader(
      @JsonProperty("frameType") FrameType frameType,
      @JsonProperty("trailerOffset") int trailerOffset,
      @JsonProperty("frameCreator") String frameCreator,
      @JsonProperty("frameDestination") String frameDestination,
  ...
  /**
   * Constructor to be used with FrameParsingUtility
   * separates error handling from creation of cd11frameheader
   *
   * @param frameType        numeric identifier of this frame type
   * @param trailerOffset    byte offset from first byte of the frame to the beginning of the
   *                         trailer
   ...
   */
  public Cd11FrameHeader(FrameType frameType, int trailerOffset, String frameCreator,
  ...
  private void validate() {
    checkState(this.trailerOffset > 0, "trailerOffset must be positive");
