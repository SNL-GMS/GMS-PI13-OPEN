...
public class Cd11FrameTrailer {
   ...
   */
  public Cd11FrameTrailer(ByteBuffer frameSegment1, ByteBuffer frameSegment2) {
   ...
   * the authentication value field; if non-zero, then authentication is used to verify
   * communications.
   * @param authenticationSize size of the authenticationValue, so the bytes are able to be read out
   * correctly
   ...
   */
  public Cd11FrameTrailer(
          @JsonProperty("authenticationKeyIdentifier") int authenticationKeyIdentifier,
          @JsonProperty("authenticationSize") int authenticationSize,
          @JsonProperty("authenticationValue") byte[] authenticationValue,
          @JsonProperty("commVerification") long commVerification
  ) {
    this.authenticationKeyIdentifier = authenticationKeyIdentifier;
    this.authenticationSize = authenticationSize;
    this.authenticationValue = authenticationValue;
    this.commVerification = commVerification;
  }
