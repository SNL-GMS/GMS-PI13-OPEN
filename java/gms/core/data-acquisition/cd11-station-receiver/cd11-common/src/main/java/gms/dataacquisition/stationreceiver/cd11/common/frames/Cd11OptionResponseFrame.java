...
public class Cd11OptionResponseFrame extends Cd11Frame {
   ...
   */
  public Cd11OptionResponseFrame(Cd11ByteFrame cd11ByteFrame) {
    super(cd11ByteFrame);
   ...
   */
  public Cd11OptionResponseFrame(int optionType, String optionResponse, PartialFrame partialFrame) {
