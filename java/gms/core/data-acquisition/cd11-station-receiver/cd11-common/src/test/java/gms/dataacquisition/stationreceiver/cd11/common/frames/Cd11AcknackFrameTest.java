...
public class Cd11AcknackFrameTest {
  ...
  private static ByteBuffer initAcknack() {
  ...
  @Test
  public void testAcknackParsing() throws IOException, InterruptedException {
    ...
    assertEquals(HIGHEST_SEQ_NUM, acknackFrame.highestSeqNum);
    assertEquals(LOWEST_SEQ_NUM, acknackFrame.lowestSeqNum);
    assertEquals(GAP_COUNT, acknackFrame.gapCount);
    assertArrayEquals(GAPS, acknackFrame.gapRanges);
