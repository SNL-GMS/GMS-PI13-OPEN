...
public class FrameHeaderTestUtility {
  ...
  public static Cd11FrameHeader createHeaderForConnectionRequest() {
  ...
  public static Cd11FrameHeader createHeaderForConnectionResponse() {
  ...
  public static Cd11FrameHeader createHeaderForAcknack() {
  ...
  public static Cd11FrameHeader createHeaderForData(int trailerOffset) {
  ...
  public static Cd11FrameHeader createHeaderForAlert(int paddedMessageLength) {
