...
public class Application {
   ...
   */
  private static void execute(CssEventAndSignalDetectionConverterArguments args) {
    ...
    if(outputFilesExist(outputDirString)){
      ...
      try {
        ...
        final CssEventAndSignalDetectionConverter converter = new
            CssEventAndSignalDetectionConverter(args);
        logger.info("Successfully read and converted {} events and {} signal detections; "
                        + "writing out to {} and {}, respectively",
   ...
   * @param outputDirString the output directory for event and signal detection files
