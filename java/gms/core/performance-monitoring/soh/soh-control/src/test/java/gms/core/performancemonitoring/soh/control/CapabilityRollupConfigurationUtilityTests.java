...
class CapabilityRollupConfigurationUtilityTests {
    ...
    return Stream.of(
        Arguments.arguments(
            ...
            (Consumer<CapabilityRollupConfigurationUtility>)
                CapabilityRollupConfigurationUtilityTests::assertUtilityTest1,
  ...
  private static ConfigurationConsumerUtility getFileConsumerUtility(String basepath) {
    ...
    ).configurationNamePrefixes(Set.of("soh-control")).build();

  }

  private static void assertUtilityTest1(CapabilityRollupConfigurationUtility utility) {
