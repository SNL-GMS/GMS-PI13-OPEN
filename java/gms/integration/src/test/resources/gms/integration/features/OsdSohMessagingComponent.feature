@integration @component @soh @kafka @soh-messaging
Feature: We want to verify that the OSD Kafka consumers can consume messages at an acceptable rate
  ...
  topic z at an acceptable rate and the consumers do not fail.
    ...
    Then I can verify <batchCount> batches of <messages> messages were received on <topic>
    ...
    #  | 10         | 15         | "STATION_SOH_ID"               | "PT1.0S"         | "soh.station-soh" | "gms/integration/data/BOSAStationSoh.json"                    | "STATION_SOH"            |
      | 10         | 4800       | "ACEI_ID"                      | "PT1.0S"         | "soh.acei"        | "gms/integration/data/soh_acei_boolean.json"                  | "ACEI_BOOLEAN"           |
      | 10         | 600        | "ACEI_ID"                      | "PT1.0S"         | "soh.acei"        | "gms/integration/data/soh_acei_analog.json"                   | "ACEI_ANALOG"            |
