...
class ConstraintDaoConverterTest {
  ...
  public void testConstraintConverter(Constraint fromConstraint, Class<?> fromClass, Class<?> toClass){
    ...
    assertTrue(fromConstraint.equals(constraint), "from Constraint not equal to converted Constraint");
  }
