...
public class UiDataInjectorUtility {
  ...
  public static List<StationGroup> loadStationGroupsFromFile(String fullFilePath) {
    final InputStream stationGroupMappingStream = StationGroup.class.getClassLoader()
  ...
  public static StationSohMonitoringUiClientParameters buildStationSohParameters(
    ...
    for(Station station : stations) {
      ...
      Set<String>channelNames =
          station.getChannels().stream().map(Channel::getName).collect(Collectors.toSet());
      ...
      for(SohMonitorType monitorType : SohMonitorType.validTypes()) {
        channelsBySohMonitorType.put(monitorType, channelNames);
      }
      ...
      for(String channelName : channelNames) {
        ...
        ChannelSohDefinition channelSohDefinition =
          ChannelSohDefinition.create(channelName, SohMonitorType.validTypes(), sohMonitorThresholdDefinitionsBySohMonitorType);
  ...
  private static StationSohMonitoringUiClientParameters loadStationSohParametersFromFile() {
    ...
    final InputStream paramsMappingStream = StationSohMonitoringUiClientParameters.class.getClassLoader()
