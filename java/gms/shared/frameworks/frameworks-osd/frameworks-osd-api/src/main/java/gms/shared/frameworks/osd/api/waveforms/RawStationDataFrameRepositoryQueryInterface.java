...
public interface RawStationDataFrameRepositoryQueryInterface {
   ...
   * @return
   */
  @Path("/raw-station-data-frame/query/metadata-by-time")
  @POST
  ...
  List<RawStationDataFrameMetadata> retrieveRawStationDataFrameMetadataByTime(
    @RequestBody(description = "Time range for raw station data frame metadata to retrieve " +
      "from the database")
