package gms.shared.frameworks.osd.api.waveforms.util;
...
/**
 * A Response DTO class describing which {@link gms.shared.frameworks.osd.coi.channel.ChannelSegment}s
 * stored successfully, and which failed to store. References these segments via {@link
 * ChannelSegmentDescriptor}s.
 *
 * @see gms.shared.frameworks.osd.coi.channel.ChannelSegment
