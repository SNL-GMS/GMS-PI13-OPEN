...
public class ChannelMonitorTypeQuietedBuilderTest {

  @Test
  public void testChannelMonitorTypeQuietedBuilderWithoutComment() {
  ...
  @Test
  public void testChannelMonitorTypeQuietedBuilderWithComment() {
    String stationName = "stationA";
    String channelName = "channelA";
    SohMonitorType sohMonitorType = SohMonitorType.MISSING;
    Duration timeInterval = Duration.ofDays(1);
