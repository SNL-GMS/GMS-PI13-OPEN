...
public class ChannelMonitorTypeStatusChangeAcknowledgedBuilderTest {

  @Test
  public void testChannelMonitorTypeStatusChangeAcknowledgedBuilderWithoutComment() {
  ...
  @Test
  public void testChannelMonitorTypeStatusChangeAcknowledgedBuilderWithComment() {
    String stationName = "stationA";
    String channelName = "channelA";
    SohMonitorType sohMonitorType = SohMonitorType.ENV_AMPLIFIER_SATURATION_DETECTED;
    String userName = "gms";
