...
public class ChannelDao {
  ...
  private static class Builder {
    ...
    public Builder withProcessingMetadata(String processingMetadat) {
      this.processingMetadata = processingMetadat;
      return this;
    }
  ...
  public static ChannelDao from(Channel channel) {
    String processingDefinition = jsonObjectMapper.valueToTree(channel.getProcessingDefinition()).toString();
    String processingMetadata = jsonObjectMapper.valueToTree(channel.getProcessingMetadata()).toString();
