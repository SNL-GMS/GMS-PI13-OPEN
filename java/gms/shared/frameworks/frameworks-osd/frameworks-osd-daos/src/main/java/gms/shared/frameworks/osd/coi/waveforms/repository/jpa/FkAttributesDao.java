...
public class FkAttributesDao {
  ...
  @ManyToOne
  @JoinColumn(name = "fk_spectrum_id", referencedColumnName = "id")
  private FkSpectrumDao fkSpectrum;
  ...
  public FkSpectrumDao getFkSpectrum() {
    return fkSpectrum;
  }

  public void setFkSpectrum(
      FkSpectrumDao fkSpectrum) {
    this.fkSpectrum = fkSpectrum;
  }
  ...
  public boolean equals(Object o) {
    ...
    return primaryKey == that.primaryKey &&
        ...
        fkSpectrum.equals(that.fkSpectrum);
  }
