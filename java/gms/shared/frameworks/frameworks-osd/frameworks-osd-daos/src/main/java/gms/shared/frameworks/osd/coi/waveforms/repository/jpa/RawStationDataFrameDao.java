...
public class RawStationDataFrameDao {
  ...
  @Column(name = "payload_format", columnDefinition = "rsdf_payload_format")
  ...
  public RawStationDataFrameDao(RawStationDataFrame df) {
    ...
    for (Map.Entry<String, WaveformSummary> entry : df.getMetadata().getWaveformSummaries().entrySet()) {
