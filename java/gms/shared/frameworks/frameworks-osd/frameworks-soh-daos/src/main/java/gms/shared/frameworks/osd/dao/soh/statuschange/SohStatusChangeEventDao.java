...
public class SohStatusChangeEventDao {
    ...
    public void setStationDao(StationDao station) { this.station =station;}

    public Collection<SohStatusChangeDao> getSohStatusChangeDaos() {return  sohStatusChangeDaos;}

    public void setSohStatusChangeDaos(Collection<SohStatusChangeDao> sohStatusChangeDaos) {this.sohStatusChangeDaos =sohStatusChangeDaos; }
