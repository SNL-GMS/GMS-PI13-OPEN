...
public class SohStatusChangeQuietedDao {
  ...
  public Duration getQuietDuration() {return this.quietDuration; }

  public void setQuietDuration(Duration quietDuration) {this.quietDuration =quietDuration; }
  ...
  public void setStation(StationDao stationDao) {this.station=stationDao;}
