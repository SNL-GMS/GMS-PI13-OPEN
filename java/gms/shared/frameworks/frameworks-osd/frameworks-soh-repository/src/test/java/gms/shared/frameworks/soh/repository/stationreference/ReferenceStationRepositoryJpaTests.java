...
import static gms.shared.frameworks.soh.repository.util.TestFixtures.UNKNOWN_ID;
...
@Testcontainers
@Disabled
public class ReferenceStationRepositoryJpaTests extends DbTest {
  ...
  public void retrieveStationMembershipsByStationIdTest() {
    ...
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationId(List.of(UNKNOWN_ID));
  ...
  public void retrieveStationMembershipsBySiteIdTest() {
    ...
    // query for bad ID, expect no results
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsBySiteId(List.of(UNKNOWN_ID));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
  }
  ...
  public void retrieveStationMembershipsByStationAndSiteIdTest() {
    ...
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationAndSiteId(
            ReferenceStationMembershipRequest.create(UNKNOWN_ID, UNKNOWN_ID));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationAndSiteId(ReferenceStationMembershipRequest.create(stationId, UNKNOWN_ID));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationAndSiteId(ReferenceStationMembershipRequest.create(UNKNOWN_ID, siteId));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
  }
