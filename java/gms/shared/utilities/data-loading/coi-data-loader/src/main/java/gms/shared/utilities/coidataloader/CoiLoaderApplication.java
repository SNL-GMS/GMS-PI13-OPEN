...
public class CoiLoaderApplication {
  ...
  public static void main(String[] commandLineArgs) {
    try {
      ...
      final SohRepositoryInterface osd = args.getUseService() ?
          ClientGenerator.createClient(SohRepositoryInterface.class)
          : SohRepositoryFactory.createSohRepository(SystemConfig.create("coi-loader"));
