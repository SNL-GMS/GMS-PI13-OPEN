...
public class FirTests {
   ...
   */
  @Test
  public void testFilterImpulseTrain() {
  ...
  @Test
  public void testFilterEmptyInputs() {
    double[] bCoefficients = new double[]{1.23, 9.87, 2.34, 8.76, 3.45, 7.65, 4.56, 6.54};
  ...
  @Test
  public void testFilterEmptyCeofficientsExpectIllegalArgumentException() {
  ...
  @Test
  public void testFilterNullInputExpectNullPointerException() {
  ...
  @Test
  public void testFilterNullIBCoefficientsExpectNullPointerException() {
    NullPointerException actual = assertThrows(NullPointerException.class,
