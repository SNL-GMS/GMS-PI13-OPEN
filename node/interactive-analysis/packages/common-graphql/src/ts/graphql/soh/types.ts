...
export type SohStationAndGroupStatusQueryProps = {
  sohStationAndGroupStatusQuery: QueryControls<{}> & {
...
export type ChannelSohForStationQueryProps = {
  channelSohForStationQuery: QueryControls<{}> & {
    channelSohForStation: ChannelSohForStation;
  };
};
...
/**
 * Input used to query against station trendline (issues) for a specific issue topic
 */
