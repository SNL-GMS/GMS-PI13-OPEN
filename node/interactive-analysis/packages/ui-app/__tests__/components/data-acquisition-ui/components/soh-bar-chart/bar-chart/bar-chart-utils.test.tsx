...
} from '@gms/ui-app/src/ts/components/data-acquisition-ui/shared/toolbars/soh-toolbar-items';
// import { gmsColors } from '@gms/ui-app/src/ts/scss-config/color-preferences';
import {
  buildData,
...
describe('Bar chart utils', () => {
  ...
  const channelSohs: SohTypes.ChannelSoh[] = [
    {
      ...
      allSohMonitorValueAndStatuses: [
        ...
        {
          monitorType: SohMonitorType.TIMELINESS,
          value: 11,
          valuePresent: true,
          status: SohTypes.SohStatusSummary.GOOD,
          hasUnacknowledgedChanges: true,
  ...
  it('should have convertChannelSohToValueWithStatus function return for maybeMatchingMonitorValue true', () => {
    const sohMonitorType: SohMonitorType = SohMonitorType.LAG;
  ...
  it('should have convertChannelSohToValueWithStatus function return for maybeMatchingMonitorValue false', () => {
    const sohMonitorType: SohMonitorType = SohMonitorType.MISSING;
    expect(convertChannelSohToValueWithStatus(channelSohs, sohMonitorType)).toEqual([
      {
        hasUnacknowledgedChanges: false,
        isNullData: true,
  ...
  it('should getName of monitor types', () => {
    let sohMonitorType: SohMonitorType = SohMonitorType.MISSING;
  ...
  it('should geDataType of monitor types', () => {
    let sohMonitorType: SohMonitorType = SohMonitorType.MISSING;
    expect(getDataType(sohMonitorType)).toEqual('%');

    sohMonitorType = SohMonitorType.LAG;
    expect(getDataType(sohMonitorType)).toEqual('s');
  ...
  xit('should get gms color based on status passed in', () => {
