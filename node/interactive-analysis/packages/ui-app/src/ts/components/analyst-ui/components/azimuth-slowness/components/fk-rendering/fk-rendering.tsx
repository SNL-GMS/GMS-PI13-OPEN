...
export class FkRendering extends React.Component<FkRenderingProps, FkRenderingState> {
  ...
  public render() {
    return (
      ...
      >
        <div ref={ref => (this.containerRef = ref)} className="fk-rendering">
          <div ref={ref => (this.yAxisContainerRef = ref)} className="fk-rendering__y-axis" />
          <div ref={ref => (this.xAxisContainerRef = ref)} className="fk-rendering__x-axis" />
