...
> {
  ...
  public render() {
    ...
    const fkThumbnailMenuPopup = (
      <Menu>
        <MenuItem onClick={e => this.props.updateFkThumbnail(FkThumbnailSize.SMALL)} text="Small" />
        <MenuItem
          onClick={e => this.props.updateFkThumbnail(FkThumbnailSize.MEDIUM)}
          text="Medium"
        />
        <MenuItem onClick={e => this.props.updateFkThumbnail(FkThumbnailSize.LARGE)} text="Large" />
        <MenuDivider />
        <MenuItem onClick={e => this.props.clearSelectedUnassociatedFks()} text="Clear selected" />
      </Menu>
    );
