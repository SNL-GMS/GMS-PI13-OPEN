 ...
 */
export class WorkflowRow extends React.Component<WorkflowRowProps, WorkflowRowState> {
  /**
   * Constructor.
   *
        ...
        {this.props.stage.intervals.map(interval => {
            ...
            if (activityIntervalToUse !== undefined) {
              return (
                <ActivityIntervalCell
                  ...
                  triggerActivityIntervalContextMenu={this.triggerActivityIntervalContextMenu}
          ...
          return (
            <StageIntervalCell
              ...
              triggerStageIntervalContextMenu={this.triggerStageIntervalContextMenu}
              isSelected={false}
            />
          );
        })}
  ...
  private readonly triggerStageIntervalContextMenu = (
    ...
    this.props.showStageIntervalContextMenu(event, this.props.stage, interval, activityInterval);
  }
