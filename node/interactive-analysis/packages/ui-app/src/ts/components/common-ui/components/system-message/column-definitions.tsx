 ...
 */
const idColumnDef = (): StringColumnDefinition => ({
  colId: 'id',
  field: 'id',
  headerName: 'ID',
  headerTooltip: 'ID',
 ...
 */
const timestampColumnDef = (valueGetter: NumberValueGetter): StringColumnDefinition => ({
  colId: 'time',
  ...
  valueGetter,
  cellRendererFramework: SystemMessageCellRenderer,
  valueFormatter: params => toDateTimeString(params.value / 1000)
});
 ...
 */
const categoryColumnDef = (valueGetter: StringValueGetter): StringColumnDefinition => ({
  colId: 'category',
  headerName: 'Category',
 ...
 */
const subCategoryColumnDef = (valueGetter: StringValueGetter): StringColumnDefinition => ({
  colId: 'subCategory',
 ...
 */
const severityColumnDef = (valueGetter: StringValueGetter): StringColumnDefinition => ({
  colId: 'severity',
  headerName: 'Severity',
 ...
 */
const messageColumnDef = (valueGetter: StringValueGetter): StringColumnDefinition => ({
  colId: 'message',
  headerName: 'Message',
...
export const buildColumnDefs = (
  ...
  timeValueGetter: NumberValueGetter,
