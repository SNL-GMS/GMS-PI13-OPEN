 ...
 */
export const MonitorTypeCellRendererBase: React.FunctionComponent<Partial<
  CellRendererParams<{ id: string }, {}, string, {}, {}>
> &
  EnvironmentTableRow> = props => (
 ...
 */
export const MonitorTypeCellRenderer = (props: MonitorTypeCellRendererParams) => (
