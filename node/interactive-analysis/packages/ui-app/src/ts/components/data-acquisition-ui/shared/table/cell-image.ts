...
export class CellImage {
  ...
  public constructor(iteration: number, message: string, isBackground: boolean) {
    this.leftIndent = this.leftIndent * iteration;
    this.topIndent = this.topIndent * iteration;
    this.opacity = 1 - this.opacity * iteration;
    this.zIndex = this.zIndex - iteration;
   ...
   */
  public readonly getElement = () => this.element;
