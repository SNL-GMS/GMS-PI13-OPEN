...
export class Form extends React.Component<FormProps, FormState> {
  ...
  public render() {
    ...
    this.state.formItemStates.forEach(
      itemState => (isAnythingModified = itemState.modified || isAnythingModified)
    );

    return (
      <div className="form" style={{ width: FORM_MIN_WIDTH.toString() + 'px' }}>
