 ...
 */
export const addGlUpdateOnShow = (glContainer: GoldenLayout.Container, callbackFn: callback) => {
 ...
 * @param callbackFn the callback to invoke on show
 */
export const addGlUpdateOnHide = (glContainer: GoldenLayout.Container, callbackFn: callback) => {
 ...
 */
export const addGlUpdateOnResize = (glContainer: GoldenLayout.Container, callbackFn: callback) => {
  if (glContainer && callbackFn) {
    // force update when the golden-layout container is resized
 ...
 * @param glContainer the golden layout container
 */
export const useForceGlUpdateOnResizeAndShow = (glContainer: GoldenLayout.Container) => {
  ...
  React.useEffect(() => {
    ...
    return () => {
      ...
      glContainer?.off && glContainer.off('show');
      glContainer?.off && glContainer?.off('resize');
    };
  }, [glContainer]);
};
