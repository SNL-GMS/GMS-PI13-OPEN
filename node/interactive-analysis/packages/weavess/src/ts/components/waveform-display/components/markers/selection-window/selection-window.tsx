...
> {
  ...
  public static getDerivedStateFromProps(
    nextProps: SelectionWindowProps,
    prevState: SelectionWindowState
  ) {
    return null; /* no-op */
  }
  ...
  private readonly updateTimeWindowSelection = () => {
    ...
    if (this.leadBorderRef.containerRef.style.left && this.endBorderRef.containerRef.style.left) {
      ...
      this.timeWindowSelectionRef.style.right = `${percent100 -
        parseFloat(this.endBorderRef.containerRef.style.left)}%`;
    }
  }
