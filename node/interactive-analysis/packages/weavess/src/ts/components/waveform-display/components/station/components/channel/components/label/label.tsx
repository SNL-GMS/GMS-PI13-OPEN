            ...
            <div className="label-container-left-parent">
              ...
              this.props.isExpandable ? (
                <div
                  ...
                  data-cy-channel-name={this.props.channel.name}
                  onClick={e => {
          ...
          <div className="label-container-content">
            <div
              ...
              style={{
                ...
                maxWidth: `calc(${
                  this.props.configuration.labelWidthPx
                  // tslint:disable-next-line: no-magic-numbers
                }px - ${84}px)`,
                // tslint:disable-next-line:no-magic-numbers
                width: `calc(${
            ...
            >
              {this.props.configuration.customLabel ? (
                <this.props.configuration.customLabel {...this.props} />
              ) : (
                <span>
            ...
            >
              {this.props.configuration.suppressLabelYAxis
                ? undefined
