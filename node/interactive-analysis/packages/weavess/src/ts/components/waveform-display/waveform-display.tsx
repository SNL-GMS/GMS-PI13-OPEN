...
> {
  ...
  public static getDerivedStateFromProps(
    ...
    if (isEqual(nextProps.configuration, configuration)) {
      derivedState = {
        ...derivedState,
        configuration
      };
    ...
    return (
      <div className="weavess">
            ...
            {this.state.measureWindowSelection ? (
              <WaveformPanel
                ...
                events={{
                  ...this.props.events,
                  stationEvents: {
                    defaultChannelEvents: this.state.measureWindowSelection.isDefaultChannel
                ...
                configuration={{
                  ...
                  defaultChannel: {
                    ...
                    disableSignalDetectionModification: this.state.measureWindowSelection
                      .isDefaultChannel
                      ? this.props.configuration &&
                        this.props.configuration.defaultChannel &&
                        this.props.configuration.defaultChannel.disableSignalDetectionModification
                      : this.props.configuration &&
                        this.props.configuration.nonDefaultChannel &&
                        this.props.configuration.nonDefaultChannel
                          .disableSignalDetectionModification,
                    disableMaskModification: this.state.measureWindowSelection.isDefaultChannel
                      ? this.props.configuration &&
                        this.props.configuration.defaultChannel &&
                  ...
                  customLabel: this.props.configuration
                    ? this.props.configuration.customMeasureWindowLabel
                    : undefined
                }}
                toast={this.toast}
                stations={[
        ...
        <div
          ...
          style={{
            height: this.state.isMeasureWindowVisible
              ? `calc(100% - ${this.state.measureWindowHeightPx}px)`
              : '100%'
          }}
        >
          <WaveformPanel
