...
export class WeavessExample extends React.Component<WeavessExampleProps, WeavessExampleState> {
    ...
    const waveformEvents: WeavessTypes.ChannelContentEvents = {
      ...
      onUpdateMarker: this.state.isUpdateMarkersEnabled
        ? (channelId: string, marker: WeavessTypes.Marker) => {
            const markerStr = `channelId: ${channelId} :: ${moment
              .unix(marker.timeSecs)
              .utc()
      ...
      onMoveSelectionWindow: this.state.isMoveSelectionWindowsEnabled
        ? (channelId: string, selection: WeavessTypes.SelectionWindow) => {
            const selectionStr = `channelId: ${channelId} :: start: ${moment
              .unix(selection.startMarker.timeSecs)
              .utc()
              .format('DD MMM YYYY HH:mm:ss')} end: ${moment
              .unix(selection.endMarker.timeSecs)
              .utc()
              .format('DD MMM YYYY HH:mm:ss')}`;
    ...
    const events: WeavessTypes.Events = {
      ...
      onMoveSelectionWindow: this.state.isMoveSelectionWindowsEnabled
        ? (selection: WeavessTypes.SelectionWindow) => {
            const selectionStr = `start: ${moment
              .unix(selection.startMarker.timeSecs)
              .utc()
              .format('DD MMM YYYY HH:mm:ss')} end: ${moment
              .unix(selection.endMarker.timeSecs)
              ...
              >
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnChannelExpandedEnabled: !this.state.isOnChannelExpandedEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnChannelCollapsedEnabled: !this.state.isOnChannelCollapsedEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnContextMenuEnabled: !this.state.isOnContextMenuEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnChannelLabelClickEnabled: !this.state.isOnChannelLabelClickEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnChannelClickEnabled: !this.state.isOnChannelClickEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnSignalDetectionClickEnabled: !this.state.isOnSignalDetectionClickEnabled
                      })
                    }
                  />
                </div>
                ...
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnPredictivePhaseClickEnabled: !this.state.isOnPredictivePhaseClickEnabled
                      })
                    }
                  />
                </div>
                ...
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnKeyPressEnabled: !this.state.isOnKeyPressEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnMaskClickEnabled: !this.state.isOnMaskClickEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isUpdateMarkersEnabled: !this.state.isUpdateMarkersEnabled
                      })
                    }
                  />
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isMoveSelectionWindowsEnabled: !this.state.isMoveSelectionWindowsEnabled
                      })
                    }
                  />
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isUpdateSelectionWindowsEnabled: !this.state.isUpdateSelectionWindowsEnabled
                      })
                    }
                  />
                  <Checkbox
                ...
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnMeasureWindowUpdatedEnabled: !this.state.isOnMeasureWindowUpdatedEnabled
                      })
                    }
                  />
                </div>
                <div style={styleFlexItem}>
                  <Checkbox
                    ...
                    onChange={() =>
                      this.setState({
                        isOnZoomChangeEnabled: !this.state.isOnZoomChangeEnabled
                      })
                    }
                  />
                </div>
  ...
  private readonly generateDummyData = () => {
                ...
                dataSegments: [
                  {
                    ...
                    data: {
                      ...
                      values: Array.from({ length: 300 }, () =>
                        Math.floor(Math.abs(WeavessUtils.RandomNumber.getSecureRandomNumber() * 15))
                      )
                    }
                  }
                ]
    ...
    for (let i = 0; i < 50; i += 1) {
      ...
      for (let samp = 0; samp < WeavessExample.NUM_SAMPLES; samp += 1) {
        sampleData1[samp] =
          Math.pow(WeavessUtils.RandomNumber.getSecureRandomNumber() - 0.5, 3) * 4;
      }
