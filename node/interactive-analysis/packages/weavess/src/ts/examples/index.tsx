  ...
  <div id="app-content">
    <HashRouter>
      ...
      >
        ...
        <Route exact={true} path="/WeavessFlatLineExample" component={WeavessFlatLineExample} />
        <Route exact={true} path="/MultipleDisplaysExample" component={MultipleDisplaysExample} />
        <Route exact={true} path="/EventsExample" component={EventsExample} />
        <Route exact={true} path="/RecordSectionExample" component={RecordSectionExample} />
      </div>
    </HashRouter>
  </div>
);
