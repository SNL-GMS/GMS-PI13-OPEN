...
function explain_basic_usage {
  ...
  echo "#############"
  echo "Mock Producer Help"
  echo "Command line tool to build, run, and manage the mock-producer."
  echo
  echo "Commands:"
  echo "  boot                                   Does it all. Stops old docker containers. Builds. Runs with any run options provided."
