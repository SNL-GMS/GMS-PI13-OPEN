...
class TestProcessingConfigLoader(unittest.TestCase):
    ...
    def test_get_config_files_mixed_configs_in_multiple_files(self):
        ...
        self.assertEqual(config_dict[key][0], {'name': self.config_json, 'path': f'{WORKING_DIR}/resources/mixed_configurations_in_multiple_files/multi_config/config.json', 'override': False})
        key = next(keys)
        self.assertEqual(key, 'test_config')
        self.assertEqual(config_dict[key][0], {'name': self.config_json, 'path': f'{WORKING_DIR}/resources/mixed_configurations_in_multiple_files/test_config/config.json', 'override': False})
    ...
    def test_create_configurations_mixed_configs_in_multiple_files(self):
      ...
      self.verify_config_option(test_config.configurationOptions[0], self.constraint1_1, 1)
      self.verify_config_option(test_config.configurationOptions[1], self.constraint1_2, 2)
      self.verify_config_option(test_config.configurationOptions[2], self.constraint2_1, 1)
      self.verify_config_option(test_config.configurationOptions[3], 'test_constraint3.1', 1)
      self.verify_config_option(test_config.configurationOptions[4], 'test_constraint3.2', 2)
      self.verify_config_option(test_config.configurationOptions[5], 'test_constraint4.1', 1)

      test_config = cfg_list[1]
      self.assertEqual(len(test_config.configurationOptions), 2)
      self.verify_config_option(test_config.configurationOptions[0], 'test_constraint', 1)
      self.verify_config_option(test_config.configurationOptions[1], 'another_test_constraint', 1)
    ...
    def test_get_config_files_mixed_configs_in_one_direcotry(self):
        ...
        key = next(keys)
        self.assertEqual(key, 'multi_config')
        self.assertEqual(config_dict[key][0], {'name': self.config_json, 'path': f'{WORKING_DIR}/resources/mixed_configurations_in_same_direcotry/multi_config/config.json', 'override': False})
    ...
    def test_create_configurations_mixed_configs_in_one_direcotry(self):
      ...
      self.verify_config_option(test_config.configurationOptions[1], self.constraint1_2, 2)
      self.verify_config_option(test_config.configurationOptions[2], self.constraint2_1, 1)
      self.verify_config_option(test_config.configurationOptions[3], 'another_test_constraint', 1)
