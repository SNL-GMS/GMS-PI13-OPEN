...
class StationProcessingLoader:
    ...
    def __init__(self, config: StationProcessingLoaderConfig, total_retries: Optional[int] = 10):
        """
        Constructor
    ...
    def load(self, station_groups_path: str):
        """
    ...
    def load_sta_group_updates(self, station_group_definitions_path: str):
        """
