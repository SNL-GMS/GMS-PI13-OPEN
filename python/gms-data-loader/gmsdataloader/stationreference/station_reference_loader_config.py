...
class StationReferenceObjectUrls:
    def __init__(self, base_url, ref_networks_route, ref_stations_route, ref_sites_route, ref_chans_route,
                 ref_sensors_route):
...
class StationReferenceMembershipUrls:
    def __init__(self, base_url, ref_network_memb_route, ref_station_memb_route, ref_site_memb_route):
